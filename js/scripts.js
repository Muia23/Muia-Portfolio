    ...
    .init(
        {
          ...
          backgroundMask: {
            ...
            cover: { color: { value: "#108c9593" }, opacity: 1 },
            enable: false
          },
          defaultThemes: {},
          delay: 0,
          ...
          interactivity: {
            ...
            modes: {
              ...
              light: {
                area: {
                  gradient: { start: { value: "#108c9593" }, stop: { value: "#108c9593" } },
                  radius: 1000
                },
                shadow: { color: { value: "#044549" }, length: 2000 }
              }
            }
          },
          manualParticles: [],
          particles: {
            ...
            shape: {
              options: {
                character: {
                  value: ["<html>", "</h3>", "<p>", "<span>", "<br>", "</td>", "<img>", "<script>", "</li>", "<ul>", "</span>"],                         
                  font: "Courier New",
                  style: "",
                  weight: "400",
                  fill: true
